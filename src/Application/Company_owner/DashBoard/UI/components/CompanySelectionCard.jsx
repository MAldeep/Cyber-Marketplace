export default function CompanySelectionCard({name , image , des , action}) {
  return (
    <div className="bg-gray-200 w-full lg:w-[30%] h-[600px] flex flex-col justify-between items-center px-[20px] py-[30px] rounded-2xl shadow-2xl hover:shadow-none transition-all hover:bg-gray-100">
      <img src={image} className="rounded-2xl object-cover w-full h-[300px]"/>
      <h1 className="text-gray-500 font-bold text-3xl">{name}</h1>
